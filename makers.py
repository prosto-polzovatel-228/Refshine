...
ADMIN_FILE = 'admins_makers.json'
CHECK_TIME = "23:59"

# === ЛОГ-БОТ НАСТРОЙКИ ===
LOG_BOT_TOKEN = '7973441371:AAELiQCvqAdB8jFqmYxQT0ib7oBWHxpU3oo'
OWNER_CHAT_ID = 5127944821
...
def confirm_handler(call):
    ...
    if call.data == "confirm_yes":
        ...
        markup.row(types.InlineKeyboardButton("Как начать?", url="https://t.me/djsjdhhfjd"), types.InlineKeyboardButton("Выплаты", url="https://t.me/Makersvuplaty"))
